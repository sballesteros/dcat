...
function _getCtnrStream(callback){
  ...
  fs.readFile(path.resolve(root, 'container.jsonld'), function(err, doc){
    ...
    ignore.addIgnoreRules(sResources.map(function(x){return x.path;}).concat(['container.jsonld', '.data', '.git', '__MACOSX', 'ld_containers', 'node_modules', 'README.md']), 'custom-rules');
